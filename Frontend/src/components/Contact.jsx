      ...
      <html lang="en">
        ...
        <body class="font-sans">
          ...
          <div class="flex w-full min-h-screen justify-center">
            <div
              class="mt-[60px] flex flex-col space-y-6 md:flex-row md:space-x-6 md:space-y-0 w-full p-8 "
            >
              <div class="flex flex-col space-y-8 justify-between">
                <div>
                  ...
                  <p class="pt-2 text-sm">
                    ...
                    laboriosam laborum numquam quibusdam
                  </p>
                </div>
                ...
                <div class=" flex space-x-5 text-2xl">
                  <div class="text-blue-400 hover:text-blue-600 hover:scale-110 ease-in-out duration-200 cursor-pointer">
                    <FaTwitter />
                  </div>
                  <div class="text-blue-400 hover:text-blue-600 hover:scale-110 ease-in-out duration-200 cursor-pointer">
                    <FaFacebook />
              ...
              <div class="md:w-100 bg-gradient-to-bl from-[#2b369a] via-[#007ecd] to-[#00b8e1] rounded-xl p-8 text-white">
                <form action="" class="flex flex-col space-y-4">
                  <div>
                    ...
                    <input
                      type="text"
                      class="text-black ring-1 ring-gray-300 w-full mt-2 rounded-md px-4 py-2 outline-none focus:ring-2 focus:ring-gray-600"
                    />
                  </div>
                  <div>
                  ...
                  <button
                    class="inline-block bg-gradient-to-tr from-black via-gray-800 to-gray-600 md:hover:bg-gradient-to-bl md:hover:scale-105 duration-200 ease-in-out text-white font-bold py-2 px-10 rounded-md uppercase text-sm"
                  >
                    Send message
                  </button>
                </form>
